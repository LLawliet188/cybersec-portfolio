      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 text-center sm:flex-row">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-md border border-white/10 bg-white/[0.03] text-secondary transition hover:border-accent/60 hover:text-primary hover:shadow-cyan-sm"
        ...
        <a
          className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.14em] text-secondary transition hover:text-accent"
          href="#home"
        >
          <ChevronUp size={14} />
